...
export const InstagramIcon: FC<IconProps> = ({ size = 32 }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <defs>
        <radialGradient
          ...
          gradientTransform="translate(20.152 457.164) rotate(-3.00009) scale(711.314 604.61)"
        >
        ...
        <radialGradient
          ...
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(135.481 359.437) rotate(-3.00009) scale(365.269 310.475)"
        >
          <stop stop-color="#FED576" />
          <stop offset="0.2634" stop-color="#F47133" />
          <stop offset="0.6091" stop-color="#BC3081" />
